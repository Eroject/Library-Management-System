...
namespace ProjectXTEST {
	...
	/// Summary for BOOK2
	/// </summary>
	public ref class BOOK2 : public System::Windows::Forms::Form
	{
	public:
		BOOK2(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(BOOK2::typeid));
			...
			this->panel2->Location = System::Drawing::Point(149, 108);
			...
			this->label1->Location = System::Drawing::Point(6, 113);
			...
			this->panel1->Location = System::Drawing::Point(149, 49);
			...
			this->label23->Location = System::Drawing::Point(6, 54);
			...
			this->button13->Location = System::Drawing::Point(76, 367);
			...
			this->button13->Click += gcnew System::EventHandler(this, &BOOK2::button13_Click);
			// 
			// button1
			// 
			...
			this->button1->Click += gcnew System::EventHandler(this, &BOOK2::button1_Click);
			// 
			// label2
			// 
			...
			this->label2->Location = System::Drawing::Point(6, 171);
			...
			this->label3->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 9, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label3->Location = System::Drawing::Point(93, 177);
			...
			this->Load += gcnew System::EventHandler(this, &BOOK2::BOOK2_Load);
		...
		/*	System::String^ lirelignedefichier(std::string filePath, int ligne)
			{
				System::String^ filenamesp;
				filenamesp = stringtostringspe(filePath);
		...
		/*	int searchWordInFile(std::string filename, String^ word)
			{
				System::String^ filenamesp;
				filenamesp = stringtostringspe(filename);
				System::IO::StreamReader^ reader = gcnew System::IO::StreamReader(filenamesp);
			...
			/*String^ Wordsoffield(std::string filePath1, int numfield)
			{
				System::String^ filePath;
				filePath = stringtostringspe(filePath1);
...
#pragma endregion
	private: System::Void BOOK2_Load(System::Object^ sender, System::EventArgs^ e) {
	}
...
private: System::Void button13_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	this->label3->Text = rechercheduligne("Livre.txt", code0, 2, code1, 3);
}
};
}
