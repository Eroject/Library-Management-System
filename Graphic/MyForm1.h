...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->pictureBox1->Location = System::Drawing::Point(117, 252);
			...
			this->button13->Location = System::Drawing::Point(84, 368);
			...
			this->button1->Location = System::Drawing::Point(308, 5);
			...
			this->panel2->Location = System::Drawing::Point(150, 163);
			...
			this->label1->Location = System::Drawing::Point(7, 168);
			...
			this->panel1->Location = System::Drawing::Point(150, 77);
			...
			this->label23->Location = System::Drawing::Point(7, 82);
			...
			this->label4->Location = System::Drawing::Point(151, 111);
			...
			this->label3->Location = System::Drawing::Point(152, 193);
...
private: System::Void button13_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	if (code0 != "" && code1 != "") {
		...
		{
			ecrireFichier("Livre.txt", code1, code0, 0, 0);
		}
		if (rechercheduligne("Livre.txt", code0, 2, code1, 3) != "ce livrre est introuvable")
		{
			int number = convertStringToInt(Wordsoffieldline(rechercheduligne("Livre.txt", code0, 2, code1, 3), 4)) + 1;
			String^ numberStr = number.ToString();
			modifyWordInFile("Livre.txt", "Livre2.txt", code0, 2, code1, 3, 4, numberStr);
			int number1 = convertStringToInt(Wordsoffieldline(rechercheduligne("Livre.txt", code0, 2, code1, 3), 5)) + 1;
			String^ numberStr1 = number1.ToString();
			modifyWordInFile("Livre.txt", "Livre2.txt", code0, 2, code1, 3, 5, numberStr1);
		}
		this->Close();
	}
	if (code0 == ""){ this->label4->Text ="entrer un nom du livre valide"; }
