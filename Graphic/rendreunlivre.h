...
namespace ProjectXTEST {
	...
	/// <summary>
	/// Summary for rendreunlivre
	/// </summary>
	public ref class rendreunlivre : public System::Windows::Forms::Form
	{
	public:
		rendreunlivre(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(rendreunlivre::typeid));
			...
			this->pictureBox1->Location = System::Drawing::Point(112, 249);
			...
			this->panel2->Location = System::Drawing::Point(147, 126);
			this->panel2->Name = L"panel2";
			this->panel2->Size = System::Drawing::Size(190, 28);
			...
			this->label1->Location = System::Drawing::Point(4, 131);
			this->label1->Name = L"label1";
			this->label1->Size = System::Drawing::Size(72, 20);
			this->label1->TabIndex = 35;
			this->label1->Text = L"Auteur :";
			...
			this->panel1->Location = System::Drawing::Point(147, 67);
			this->panel1->Name = L"panel1";
			this->panel1->Size = System::Drawing::Size(190, 28);
			...
			this->label23->Location = System::Drawing::Point(4, 72);
			this->label23->Name = L"label23";
			this->label23->Size = System::Drawing::Size(119, 20);
			this->label23->TabIndex = 32;
			this->label23->Text = L"Titre du livre :";
			...
			this->button13->Location = System::Drawing::Point(74, 365);
			this->button13->Margin = System::Windows::Forms::Padding(3, 10, 3, 3);
			this->button13->Name = L"button13";
			this->button13->Size = System::Drawing::Size(180, 45);
			this->button13->TabIndex = 31;
			this->button13->Text = L"    Rendre";
			this->button13->TextAlign = System::Drawing::ContentAlignment::MiddleLeft;
			this->button13->UseVisualStyleBackColor = false;
			this->button13->Click += gcnew System::EventHandler(this, &rendreunlivre::button13_Click);
			// 
			// button1
			// 
			...
			this->button1->Location = System::Drawing::Point(303, 2);
			this->button1->Name = L"button1";
			this->button1->Size = System::Drawing::Size(39, 29);
			this->button1->TabIndex = 30;
			this->button1->UseVisualStyleBackColor = true;
			this->button1->Click += gcnew System::EventHandler(this, &rendreunlivre::button1_Click);
			// 
			// label2
			// 
			this->label2->AutoSize = true;
			this->label2->Location = System::Drawing::Point(148, 101);
			...
			this->label3->Location = System::Drawing::Point(147, 161);
			...
			this->Name = L"rendreunlivre";
			this->Text = L"rendreunlivre";
			this->Load += gcnew System::EventHandler(this, &rendreunlivre::rendreunlivre_Load);
...
#pragma endregion
	private: System::Void rendreunlivre_Load(System::Object^ sender, System::EventArgs^ e) {
	}
...
private: System::Void button13_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	if (code0 != "" && code1 != "" ) {
		...
		{
			this->label2->Text = "ce livre n'existe pas";
		}
		if (rechercheduligne("Livre.txt", code0, 2, code1, 3) != "ce livrre est introuvable")
		{
			int number1 = convertStringToInt(Wordsoffieldline(rechercheduligne("Livre.txt", code0, 2, code1, 3), 5));//nbre des exemplaires disponibles
			int number = convertStringToInt(Wordsoffieldline(rechercheduligne("Livre.txt", code0, 2, code1, 3), 4));// nbre des exemplaire
			if(number1< number) {
				number1 = number1 +1;
			...
			if (number1 >= number) {
				this->label2->Text = "ce livre n'est pas preté ";
			}
	...
	if (code0 == "") { this->label2->Text = "entrer un nom du livre valide"; }
